        		...
        		<div class="checkout-addr">
        			...
        			<div class="addr-list-wrap">
        					...
        					<ul>
        						<li v-for="(item,index) in addressListFilter" :class="{'check':checkIndex==index}" @click="checkIndex=index;selectedAddrId=item.addressId">
        							...
        							<div class="addr-opration ">
        								<a @click="setDefault(item.addressId)"  href="javascript:;" class="addr-set-default-btn" v-if="!item.isDefault" >
        									<i>Set default</i>
        								</a>
        							</div>
        				...
        				<div class="shipping-addr-more">
        					<a @click="expand" href="javascript:;" :class="{'open':limit>3}" class="addr-more-btn up-down-btn">
        						more
        						<i class="i-up-down">
        			...
        			<div class="shippin-method-wrap">
        				<div class="shipping-method">
        					<ul>
        						<li class="check">
        							<div class="name">Standard shiping</div>
        			...
        			<div class="next-btn-wrap">
        				<router-link class="btn btn--m" :to="{path:'orderConfirm',query:{'addressId':selectedAddrId}}">Next</router-link>
        			</div>       			
        		</div>
        	</div>
		</div>
